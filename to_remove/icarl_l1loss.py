...
class iCaRLTrainer_L1():
    ...
    def train(self, split):
        ...
        for e in range(self.epochs):
            ...
            for inputs, labels in self.train_dataloader:
                ...
                # compute the loss
                loss = self.criterion(outputs, onehot_labels) + l1_loss
                # reset the gradients
    ...
    def test(self, split):
        ...
        plotConfusionMatrix("L1 Loss", confusionMatrixData)
        if split == 9:
            with open(f'cm_data_L1.pth', 'wb') as f:
